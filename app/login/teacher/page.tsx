      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-3xl shadow-md border border-gray-200 overflow-hidden">
          ...
          <div className="bg-[#1D324B] px-10 pt-10 pb-0 flex flex-col items-center">
            <h1 className="text-4xl font-black text-white tracking-widest mb-6">TEACHER</h1>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-5 py-4 bg-gray-50 border-2 border-gray-200 rounded-2xl focus:border-[#1D324B] focus:bg-white outline-none font-semibold text-[#1D324B] transition-all pr-12 placeholder:text-gray-300"
                    onKeyPress={(e) => e.key === 'Enter' && handleLogin()}
                  />
                  <button
                    type="button"
                    onClick={() => setShowPassword(!showPassword)}
                    className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 hover:text-[#1D324B] transition-colors"
                  >
